...
Búsqueda personalizada: Escribe el nombre de una ciudad en el input
Búsqueda rápida: Click en los botones de ciudades predefinidas
Ver detalles: Presiona F12 para abrir Developer Tools
Pestaña Console: Ver logs detallados de cada petición
Pestaña Network: Analizar headers, timing, y response
